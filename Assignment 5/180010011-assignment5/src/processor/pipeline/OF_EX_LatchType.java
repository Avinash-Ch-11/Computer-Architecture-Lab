...
public class OF_EX_LatchType {
	...
	boolean EX_enable;
	int immx, branchTarget, op1, op2;
	int PC, instruction;
	ControlUnit controlUnit;
	boolean isNop, EX_busy;
	...
	public boolean isEX_busy(){return this.EX_busy;}
	public void setEX_busy(boolean eX_busy){this.EX_busy=eX_busy;}
	...
	public int getImmx(){return this.immx;}
	public void setImmx(int immx){this.immx = immx;}

	public int getBranchTarget(){return this.branchTarget;}
	public void setBranchTarget(int branchTarget){this.branchTarget = branchTarget;}
	...
	public boolean getEX_enable(){return this.EX_enable;}
	public boolean isEX_enable(){return this.EX_enable;}

	public void setEX_enable(boolean eX_enable) {this.EX_enable = eX_enable;}
